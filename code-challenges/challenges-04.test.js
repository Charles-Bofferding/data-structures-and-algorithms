...
const sortMeetingsByDay = (arr) => {
  ...
  //taken from https://stackoverflow.com/questions/34066752/sort-object-of-weekdays-like-sunday-monday-saturday
  const sorter = {
    "Monday": 1,
    "Tuesday": 2,
    "Wednesday": 3,
  ...
  return arr.sort((a,b) => {
    if(sorter[a.dayOfWeek] > sorter[b.dayOfWeek]){
      return 1;
    } else if (sorter[a.dayOfWeek] < sorter[b.dayOfWeek]){
      return -1;
    } else {
      return 0;
    }
