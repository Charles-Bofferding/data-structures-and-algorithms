...
//I didn't use foreach here because it needed to run a specific number of times not based on the size of the array which forEach would use as the iterating value.
